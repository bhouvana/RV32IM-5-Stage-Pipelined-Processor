...
| 5. Extensions (RV32M/CSR/caches/prediction/etc.) | RV32I completeness (5.1, `docs/adr/0005`) and RV32M (5.2, `docs/adr/0006`) done — mul/div implemented single-cycle, a real multi-cycle divider explicitly deferred as its own future item. CSR/privilege/caches/prediction not started. |
