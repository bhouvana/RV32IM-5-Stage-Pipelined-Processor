...
**Recommended next milestone**: CSR/exceptions (Phase 5 item 3) is the largest remaining ISA-extension item. FPGA readiness (Phase 7) is blocked on `DataMemory`'s combinational-read model needing a synchronous-read variant first.
